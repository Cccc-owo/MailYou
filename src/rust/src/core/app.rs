...
use crate::protocol::{
    serialize, BackendError, BackendRequest, HealthCheckResult, SendMessageResult,
};

pub fn handle(context: &AppContext, request: BackendRequest) -> Result<serde_json::Value, BackendError> {
