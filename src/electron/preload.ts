...
const mailyou: MailyouBridge = {
  ...
  createFolder: (accountId, name) => ipcRenderer.invoke('mail:createFolder', accountId, name),
  renameFolder: (accountId, folderId, name) => ipcRenderer.invoke('mail:renameFolder', accountId, folderId, name),
  deleteFolder: (accountId, folderId) => ipcRenderer.invoke('mail:deleteFolder', accountId, folderId),
  listMessages: (accountId, folderId) => ipcRenderer.invoke('mail:listMessages', accountId, folderId),
  getDraft: (accountId, draftId) => ipcRenderer.invoke('mail:getDraft', accountId, draftId),
  searchMessages: (accountId, query) => ipcRenderer.invoke('mail:searchMessages', accountId, query),
  listLabels: (accountId) => ipcRenderer.invoke('mail:listLabels', accountId),
  getMessage: (accountId, messageId) => ipcRenderer.invoke('mail:getMessage', accountId, messageId),
  addLabel: (accountId, messageId, label) => ipcRenderer.invoke('mail:addLabel', accountId, messageId, label),
  removeLabel: (accountId, messageId, label) => ipcRenderer.invoke('mail:removeLabel', accountId, messageId, label),
  renameLabel: (accountId, label, newLabel) => ipcRenderer.invoke('mail:renameLabel', accountId, label, newLabel),
  deleteLabel: (accountId, label) => ipcRenderer.invoke('mail:deleteLabel', accountId, label),
  ...
  batchToggleRead: (accountId, messageIds, isRead) => ipcRenderer.invoke('mail:batchToggleRead', accountId, messageIds, isRead),
  ...
  batchMoveMessages: (accountId, messageIds, folderId) => ipcRenderer.invoke('mail:batchMoveMessages', accountId, messageIds, folderId),
  ...
  batchDeleteMessages: (accountId, messageIds) => ipcRenderer.invoke('mail:batchDeleteMessages', accountId, messageIds),
